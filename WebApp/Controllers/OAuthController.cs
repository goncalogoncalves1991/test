...
namespace WebApp.Controllers
{
    public class OAuthController : Controller
    {
        ...
        public async Task<ActionResult> callback()
        {
            ...
            var tempState = GetTempStateAsync().Result;
            ...
            return RedirectToAction("Ola", "Home",null);
        ...
        {
            var tempId = new ClaimsIdentity("OAuth");
        ...
        private List<Claim> ValidateToken(string token, string nonce)
        {
            ...
            var cert = Startup.LoadCertificate();
        ...
        {
            var data = await Request.GetOwinContext().Authentication.AuthenticateAsync("OAuth");
